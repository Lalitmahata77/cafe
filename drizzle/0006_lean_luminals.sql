ALTER TABLE "delivery_persons" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
DROP TABLE "delivery_persons" CASCADE;--> statement-breakpoint
ALTER TABLE "inventories" RENAME COLUMN "wareHouse_id" TO "warehouse_id";--> statement-breakpoint
